...
def upgrade() -> None:
    ...
    sa.Column('licence_bypass', sa.Boolean(), nullable=False),
    sa.Column('bypass_reason', sa.Text(), nullable=True),
    sa.Column('bypass_set_by', sa.Integer(), nullable=True),
    ...
    op.create_table('platform_sms_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('cost_per_sms', sa.Numeric(precision=10, scale=4), nullable=False),
    sa.Column('currency', sa.String(length=3), nullable=False),
    sa.Column('minimum_top_up_amount', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.Column('sms_per_unit', sa.Integer(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_platform_sms_settings'))
    )
    ...
    op.create_table('platform_whatsapp_settings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('monthly_subscription_fee', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('currency', sa.String(length=3), nullable=False),
    sa.Column('minimum_subscription_months', sa.Integer(), nullable=False),
    sa.Column('payment_method', sa.String(length=50), nullable=False),
    sa.Column('mpesa_paybill', sa.String(length=20), nullable=True),
    sa.Column('mpesa_till_number', sa.String(length=20), nullable=True),
    sa.Column('mpesa_account_name', sa.String(length=100), nullable=True),
    ...
    sa.Column('trial_days', sa.Integer(), nullable=False),
    sa.Column('trial_message_limit', sa.Integer(), nullable=False),
    sa.Column('default_message_limit_per_month', sa.Integer(), nullable=True),
    sa.Column('max_message_length', sa.Integer(), nullable=False),
    sa.Column('auto_renewal_enabled', sa.Boolean(), nullable=False),
    sa.Column('auto_renewal_grace_days', sa.Integer(), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_platform_whatsapp_settings'))
    )
    op.create_index(op.f('ix_platform_whatsapp_settings_id'), 'platform_whatsapp_settings', ['id'], unique=False)
    ...
    sa.Column('previous_configuration_id', sa.Integer(), nullable=True),
    ...
    op.create_table('whatsapp_subscription_packages',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_whatsapp_subscription_packages'))
    )
    op.create_index(op.f('ix_whatsapp_subscription_packages_id'), 'whatsapp_subscription_packages', ['id'], unique=False)
    ...
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('campaign_type', sa.Enum('SMS', 'EMAIL', 'WHATSAPP', 'BOTH', name='campaigntype'), nullable=False),
    ...
    sa.Column('category', sa.Enum('INFRASTRUCTURE', 'EQUIPMENT', 'MAINTENANCE', 'UTILITIES', 'LICENSES', 'MARKETING', 'SALARIES', 'OFFICE', 'TRAVEL', 'OTHER', name='expensecategory'), nullable=False),
    ...
    sa.Column('address', sa.Text(), nullable=True),
    sa.Column('city', sa.String(length=100), nullable=True),
    sa.Column('status', sa.Enum('NEW', 'CONTACTED', 'QUALIFIED', 'PROPOSAL', 'NEGOTIATION', 'CONVERTED', 'LOST', name='leadstatus'), nullable=False),
    sa.Column('source', sa.Enum('WEBSITE', 'REFERRAL', 'SOCIAL_MEDIA', 'ADVERTISEMENT', 'WALK_IN', 'PHONE_CALL', 'OTHER', name='leadsource'), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
    ...
    sa.Column('hotspot_username_prefix', sa.String(length=10), nullable=False),
    sa.Column('hotspot_username_counter', sa.Integer(), nullable=False),
    sa.Column('hotspot_template', sa.String(length=50), nullable=False),
    sa.Column('prune_inactive_users_days', sa.Integer(), nullable=False),
    sa.Column('hotspot_redirect_url', sa.String(length=500), nullable=False),
    sa.Column('require_username_approval', sa.Boolean(), nullable=False),
    sa.Column('allow_self_registration', sa.Boolean(), nullable=False),
    sa.Column('vpn_domain', sa.String(length=200), nullable=False),
    sa.Column('winbox_port_start', sa.Integer(), nullable=False),
    sa.Column('winbox_port_end', sa.Integer(), nullable=False),
    ...
    sa.Column('enable_mikrotik_status_notifications', sa.Boolean(), nullable=False),
    sa.Column('send_hotspot_payment_confirmation', sa.Boolean(), nullable=False),
    sa.Column('hotspot_payment_confirmation_sms', sa.Text(), nullable=True),
    sa.Column('send_pppoe_payment_confirmation', sa.Boolean(), nullable=False),
    sa.Column('pppoe_payment_confirmation_sms', sa.Text(), nullable=True),
    sa.Column('send_hotspot_expiry_notification', sa.Boolean(), nullable=False),
    sa.Column('hotspot_expiry_notification_sms', sa.Text(), nullable=True),
    sa.Column('send_pppoe_expiry_notification', sa.Boolean(), nullable=False),
    sa.Column('pppoe_expiry_notification_sms', sa.Text(), nullable=True),
    sa.Column('send_hotspot_expiry_reminder', sa.Boolean(), nullable=False),
    sa.Column('hotspot_expiry_reminder_sms', sa.Text(), nullable=True),
    sa.Column('send_pppoe_expiry_reminder', sa.Boolean(), nullable=False),
    sa.Column('pppoe_expiry_reminder_sms', sa.Text(), nullable=True),
    sa.Column('enable_email_subscription_reminders', sa.Boolean(), nullable=False),
    sa.Column('send_pppoe_email_reminders', sa.Boolean(), nullable=False),
    sa.Column('pppoe_email_reminder_subject', sa.String(length=200), nullable=True),
    sa.Column('pppoe_email_reminder_message', sa.Text(), nullable=True),
    sa.Column('whatsapp_provider', sa.String(length=50), nullable=True),
    sa.Column('whatsapp_enabled', sa.Boolean(), nullable=False),
    sa.Column('send_hotspot_payment_confirmation_whatsapp', sa.Boolean(), nullable=False),
    sa.Column('hotspot_payment_confirmation_whatsapp', sa.Text(), nullable=True),
    sa.Column('send_pppoe_payment_confirmation_whatsapp', sa.Boolean(), nullable=False),
    sa.Column('pppoe_payment_confirmation_whatsapp', sa.Text(), nullable=True),
    sa.Column('send_hotspot_expiry_notification_whatsapp', sa.Boolean(), nullable=False),
    sa.Column('hotspot_expiry_notification_whatsapp', sa.Text(), nullable=True),
    sa.Column('send_pppoe_expiry_notification_whatsapp', sa.Boolean(), nullable=False),
    sa.Column('pppoe_expiry_notification_whatsapp', sa.Text(), nullable=True),
    sa.Column('send_hotspot_expiry_reminder_whatsapp', sa.Boolean(), nullable=False),
    sa.Column('hotspot_expiry_reminder_whatsapp', sa.Text(), nullable=True),
    sa.Column('send_pppoe_expiry_reminder_whatsapp', sa.Boolean(), nullable=False),
    ...
    sa.Column('default_grace_period_days', sa.Integer(), nullable=False),
    ...
    sa.Column('free_memory', sa.BigInteger(), nullable=True),
    sa.Column('total_hdd_space', sa.BigInteger(), nullable=True),
    sa.Column('free_hdd_space', sa.BigInteger(), nullable=True),
    ...
    sa.Column('enable_burst', sa.Boolean(), nullable=False),
    sa.Column('burst_download', sa.Integer(), nullable=True),
    sa.Column('burst_upload', sa.Integer(), nullable=True),
    sa.Column('burst_threshold', sa.Integer(), nullable=True),
    sa.Column('burst_time', sa.Integer(), nullable=True),
    sa.Column('enable_schedule', sa.Boolean(), nullable=False),
    ...
    op.create_index(op.f('ix_sms_credit_accounts_organization_id'), 'sms_credit_accounts', ['organization_id'], unique=False)
    op.create_table('sms_gateway_configs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=True),
    sa.Column('provider_type', sa.Enum('AFRICASTALKING', 'TWILIO', 'SMS_GLOBAL', 'CUSTOM', name='smsprovidertype'), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'PENDING_VERIFICATION', 'ERROR', name='smsgatewaystatus'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('is_primary', sa.Boolean(), nullable=False),
    sa.Column('environment', sa.String(length=20), nullable=False),
    sa.Column('credentials', sa.Text(), nullable=True),
    sa.Column('default_sender_id', sa.String(length=50), nullable=True),
    sa.Column('webhook_url', sa.String(length=500), nullable=True),
    ...
    op.create_index(op.f('ix_sms_gateway_configs_id'), 'sms_gateway_configs', ['id'], unique=False)
    op.create_index(op.f('ix_sms_gateway_configs_organization_id'), 'sms_gateway_configs', ['organization_id'], unique=False)
    op.create_index(op.f('ix_sms_gateway_configs_provider_type'), 'sms_gateway_configs', ['provider_type'], unique=False)
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=False),
    sa.Column('level', sa.Enum('ERROR', 'WARNING', 'INFO', 'SUCCESS', name='loglevel'), nullable=False),
    ...
    op.create_index(op.f('ix_system_logs_organization_id'), 'system_logs', ['organization_id'], unique=False)
    ...
    op.create_table('whatsapp_gateway_configs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=True),
    sa.Column('provider_type', sa.Enum('APIWAP', 'TWILIO_WHATSAPP', 'CUSTOM', name='whatsappprovidertype'), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'PENDING_VERIFICATION', 'ERROR', name='whatsappgatewaystatus'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    sa.Column('is_primary', sa.Boolean(), nullable=False),
    sa.Column('environment', sa.String(length=20), nullable=False),
    sa.Column('credentials', sa.Text(), nullable=True),
    ...
    op.create_index(op.f('ix_whatsapp_gateway_configs_id'), 'whatsapp_gateway_configs', ['id'], unique=False)
    op.create_index(op.f('ix_whatsapp_gateway_configs_organization_id'), 'whatsapp_gateway_configs', ['organization_id'], unique=False)
    op.create_index(op.f('ix_whatsapp_gateway_configs_provider_type'), 'whatsapp_gateway_configs', ['provider_type'], unique=False)
    op.create_table('whatsapp_organization_subscriptions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=False),
    sa.Column('package_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'SUSPENDED', 'EXPIRED', 'CANCELLED', 'PENDING', name='whatsappsubscriptionstatus'), nullable=False),
    sa.Column('provider_type', sa.Enum('APIWAP', 'TWILIO_WHATSAPP', 'CUSTOM', name='whatsappprovidertype'), nullable=False),
    ...
    sa.Column('messages_sent_this_month', sa.Integer(), nullable=False),
    sa.Column('total_messages_sent', sa.Integer(), nullable=False),
    sa.Column('last_message_sent_at', sa.DateTime(), nullable=True),
    sa.Column('apiwap_account_id', sa.String(length=100), nullable=True),
    sa.Column('apiwap_account_created_at', sa.DateTime(), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('created_by', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_whatsapp_organization_subscriptions_id'), 'whatsapp_organization_subscriptions', ['id'], unique=False)
    op.create_index(op.f('ix_whatsapp_organization_subscriptions_organization_id'), 'whatsapp_organization_subscriptions', ['organization_id'], unique=False)
    op.create_index(op.f('ix_whatsapp_organization_subscriptions_status'), 'whatsapp_organization_subscriptions', ['status'], unique=False)
    ...
    sa.Column('attachments', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'SENT', 'DELIVERED', 'FAILED', 'BOUNCED', 'OPENED', 'CLICKED', name='emailstatus'), nullable=False),
    sa.Column('error_message', sa.Text(), nullable=True),
    sa.Column('sent_at', sa.DateTime(), nullable=True),
    sa.Column('delivered_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('hotspot_username', sa.String(length=50), nullable=True),
    sa.Column('hotspot_password', sa.String(length=20), nullable=True),
    ...
    op.create_index(op.f('ix_voucher_codes_hotspot_username'), 'voucher_codes', ['hotspot_username'], unique=False)
    ...
    sa.Column('cost', sa.Numeric(precision=6, scale=4), nullable=True),
    sa.Column('currency', sa.String(length=3), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_whatsapp_messages_subscription_id'), 'whatsapp_messages', ['subscription_id'], unique=False)
    op.create_table('whatsapp_subscription_payments',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('subscription_id', sa.Integer(), nullable=False),
    sa.Column('organization_id', sa.Integer(), nullable=False),
    sa.Column('payment_reference', sa.String(length=100), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', name='whatsapptransactionstatus'), nullable=False),
    sa.Column('status_message', sa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('paid_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_whatsapp_subscription_payments_organization_id'), 'whatsapp_subscription_payments', ['organization_id'], unique=False)
    op.create_index(op.f('ix_whatsapp_subscription_payments_payment_reference'), 'whatsapp_subscription_payments', ['payment_reference'], unique=True)
    op.create_index(op.f('ix_whatsapp_subscription_payments_status'), 'whatsapp_subscription_payments', ['status'], unique=False)
    op.create_index(op.f('ix_whatsapp_subscription_payments_subscription_id'), 'whatsapp_subscription_payments', ['subscription_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_whatsapp_subscription_payments_subscription_id'), table_name='whatsapp_subscription_payments')
    op.drop_index(op.f('ix_whatsapp_subscription_payments_status'), table_name='whatsapp_subscription_payments')
    op.drop_index(op.f('ix_whatsapp_subscription_payments_payment_reference'), table_name='whatsapp_subscription_payments')
    op.drop_index(op.f('ix_whatsapp_subscription_payments_organization_id'), table_name='whatsapp_subscription_payments')
    op.drop_index(op.f('ix_whatsapp_subscription_payments_id'), table_name='whatsapp_subscription_payments')
    op.drop_table('whatsapp_subscription_payments')
    op.drop_index(op.f('ix_whatsapp_messages_subscription_id'), table_name='whatsapp_messages')
    ...
    op.drop_index(op.f('ix_voucher_codes_hotspot_username'), table_name='voucher_codes')
    ...
    op.drop_index(op.f('ix_whatsapp_organization_subscriptions_status'), table_name='whatsapp_organization_subscriptions')
    op.drop_index(op.f('ix_whatsapp_organization_subscriptions_organization_id'), table_name='whatsapp_organization_subscriptions')
    op.drop_index(op.f('ix_whatsapp_organization_subscriptions_id'), table_name='whatsapp_organization_subscriptions')
    op.drop_table('whatsapp_organization_subscriptions')
    op.drop_index(op.f('ix_whatsapp_gateway_configs_provider_type'), table_name='whatsapp_gateway_configs')
    op.drop_index(op.f('ix_whatsapp_gateway_configs_organization_id'), table_name='whatsapp_gateway_configs')
    op.drop_index(op.f('ix_whatsapp_gateway_configs_id'), table_name='whatsapp_gateway_configs')
    op.drop_table('whatsapp_gateway_configs')
    ...
    op.drop_index(op.f('ix_system_logs_organization_id'), table_name='system_logs')
    ...
    op.drop_index(op.f('ix_sms_gateway_configs_provider_type'), table_name='sms_gateway_configs')
    op.drop_index(op.f('ix_sms_gateway_configs_organization_id'), table_name='sms_gateway_configs')
    op.drop_index(op.f('ix_sms_gateway_configs_id'), table_name='sms_gateway_configs')
    op.drop_table('sms_gateway_configs')
    op.drop_index(op.f('ix_sms_credit_accounts_organization_id'), table_name='sms_credit_accounts')
    ...
    op.drop_index(op.f('ix_whatsapp_subscription_packages_id'), table_name='whatsapp_subscription_packages')
    op.drop_table('whatsapp_subscription_packages')
    ...
    op.drop_index(op.f('ix_platform_whatsapp_settings_id'), table_name='platform_whatsapp_settings')
    op.drop_table('platform_whatsapp_settings')
