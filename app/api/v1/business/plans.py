...
async def create_plan(
    ...
    try:
        plan = await service.create_plan(
            ...
            enable_burst=plan_data.enable_burst,
            ...
            enable_schedule=plan_data.enable_schedule,
            schedule_start_time=plan_data.schedule_start_time,
            schedule_end_time=plan_data.schedule_end_time,
