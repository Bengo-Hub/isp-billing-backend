...
async def verify_basic_configuration(api, config: Dict[str, Any]) -> None:
...
async def verify_service_configuration(api, service_type: ServiceType, config: Dict[str, Any]) -> None:
